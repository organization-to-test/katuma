...
ActiveRecord::Schema.define(:version => 20131021170911) do
  ...
  add_index "waiting_users", ["user_id", "waiting_list_id"], :name => "index_waiting_users_on_user_id_and_waiting_list_id"
